...
def main():
    ...
    parser.add_argument('--train_module', default='transt', type=str, help='Name of module in the "train_settings/" folder.')
    parser.add_argument('--train_name', default='transt_light-feature-fusion_500e_bs76', type=str, help='Name of the train settings file.')
