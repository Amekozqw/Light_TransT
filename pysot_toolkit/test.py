...
parser.add_argument('--name', default='TransT_light_500e_bs128', type=str,
...
def main():
    ...
    dataset_root = '/share/xlsun/dataset/full_data/test' #Absolute path of the dataset
    # net_path = '/data/xlsun/code/TransT_light/results/TransT_light_500e_bs76/checkpoints/ltr/transt/transt_light_500e_bs76/TransT_ep0500.pth.tar' #Absolute path of the model
    net_path = '/data/xlsun/code/TransT_light/results/TransT_light_500e_bs128/checkpoints/ltr/transt/transt_light_500e_bs128/TransT_ep0500.pth.tar' #Absolute path of the model
